...
<div class="container-fluid mt-3 pt-2">
    <h4 class="text-center text-white">List of Our Wedding Venues</h4>
    <hr class="divider">
    <div class="row-items">
        <div class="col-lg-12">
            <div class="row">
                                ...
                                <div class="row align-items-center justify-content-center text-center h-100">
                                    <div class="">
                                        ...
                                        <div>
                                            ...
                                            <br>
                                            <br>
                                            <button class="btn btn-primary book-venue align-self-end" type="button" data-id='<?php echo $row['id'] ?>'>Full Booking</button>
                                            <button class="btn btn-primary custombook-venue align-self-end" type="button" data-id='<?php echo $row['id'] ?>'>Custom Booking</button>
...
<script>
    ...
    $('.custombook-venue').click(function() {
        uni_modal("Submit Booking Request", "custombooking.php?venue_id=" + $(this).attr('data-id'))
    })
